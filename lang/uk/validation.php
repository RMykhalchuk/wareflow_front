...
return [
    ...
    */
    ...
    "password.symbols" => "Поле \":attribute\" має містити принаймні один спец. символ.",
    "password.uncompromised" => "Поле \":attribute\" з'явився під час витоку даних. Виберіть інший \":attribute\".",
    "password.not_all_same" => "Пароль занадто простий. Використовуйте комбінацію літер і цифр та уникайте однакових символів.",
