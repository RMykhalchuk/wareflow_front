                ...
                <table class="sticker-wrapper" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="sticker-left">
                            <div>
                                <div class="label-top">
                                    <div class="label-type">Комірка</div>
                                ...
                                <div class="meta-row">
                                    <p class="meta-title">Сектор</p>
                                    <p class="meta-value">
                                        {{ $label['sector'] ?? ($label->sector ?? substr($label['code'] ?? '', 0, 1)) }}
                                    </p>
                                </div>

                                <div class="meta-row">
                                    <p class="meta-title">Зона</p>
                                    <p class="meta-value">
