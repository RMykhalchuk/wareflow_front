                ...
                <div class="sticker-left gap-50">
                    <div class="d-flex gap-50 flex-column">
                        <div class="d-flex gap-25 flex-column">
                            <h3 class="text-black mb-0">Комірка</h3>
                        ...
                        <div class="d-flex gap-25 flex-column">
                            <h4 class="text-black mb-0">Сектор</h4>
                            <h3 class="text-black mb-0 fw-bolder">A</h3>
                        </div>

                        <div class="d-flex gap-25 flex-column">
                            <h4 class="text-black mb-0">Зона</h4>
                            <h3 class="text-black mb-0 fw-bolder">Приймання</h3>
                        </div>
