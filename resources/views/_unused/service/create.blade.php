...
@section('title', __('localization.services_create_title'))
@section('page-style')
...
@section('content')
    <div class="container-fluid px-2">
                    ...
                    <ol class="breadcrumb breadcrumb-slash">
                        <li class="breadcrumb-item">
                            <a class="link-secondary" href="/services">
                                {{ __('localization.services_create_breadcrumb_services') }}
                            </a>
                        </li>

                        <li class="breadcrumb-item fw-bolder active" aria-current="page">
                            {{ __('localization.services_create_breadcrumb_add_service') }}
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card p-2 pb-4">
            <h4 class="mb-2 fw-bolder">{{ __('localization.services_create_basic_data') }}</h4>

            <div class="row pb-4">
                <div class="col-12 col-sm-6 input-with-switch mb-1">
                    <div class="w-100 mr-1">
                        <label class="form-label" for="basicInput">
                            {{ __('localization.services_create_label_name') }}
                        </label>
                        <input
                            type="text"
                            class="form-control"
                            id="basicInput"
                            placeholder="{{ __('localization.services_create_placeholder_name') }}"
                        />
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 mb-1">
                    <label class="form-label" for="select-service-category">
                        {{ __('localization.services_create_label_category') }}
                    </label>
                    <select
                        class="select2 form-select"
                        id="select-service-category"
                        data-dictionary="service_category"
                        data-placeholder="{{ __('localization.services_create_placeholder_category') }}"
                    >
                        <option value=""></option>
                    </select>
                </div>
                ...
                <div class="col-12 col-sm-6 mb-1">
                    <textarea
                        ...
                        rows="3"
                        placeholder="{{ __('localization.services_create_placeholder_comment') }}"
                    ></textarea>
                </div>

                <div class="col-12">
                    <div id="alert-error" class="alert alert-danger d-none" role="alert">
                        {{ __('localization.services_create_error_alert') }}
                    </div>
                </div>
            </div>
        </div>
