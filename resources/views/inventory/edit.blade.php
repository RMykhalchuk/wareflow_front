...
@section('content')
            ...
            @include(
                ...
                [
                    'options' => [
                        ...
                        [
                            'name' => __('localization.inventory.edit.create_inventory'),
                        ],
                    ],
                ]
            )
        ...
        <x-slot:slot>
            ...
            >
                <div class="d-flex gap-1 align-items-center">
                    <x-page-title
                        :title="__('localization.inventory.create.title') . ' №' . $inventory->local_id"
                    />
                ...
                <x-card.nested id="block_1_full">
                    ...
                    <x-slot:body>
                        <x-form.switch
                            ...
                            :checked="$inventory->show_leftovers"
                        />
                        ...
                        <x-form.switch
                            ...
                            class="w-full mb-1"
                            :checked="$inventory->restrict_goods_movement"
                        />
                        ...
                        <x-form.select
                            ...
                            multiple
                            data-id='{{ json_encode($inventory->performers?->pluck("id") ?? []) }}'
                        />
                        ...
                        <div class="col-6 d-flex flex-column gap-25">
                            ...
                            <div id="priority_full" class="d-flex flex-wrap gap-25">
                                @foreach (range(0, 10) as $i)
                                    <button
                                        type="button"
                                        class="priority-btn {{ $i === $inventory->priority ? 'active' : '' }}"
                                        data-value="{{ $i }}"
                                    >
                                        {{ $i }}
                                    </button>
                ...
                <x-card.nested id="block_2_full">
                    ...
                    <x-slot:body>
                        <x-form.select
                            ...
                            data-id="{{ $inventory->warehouse_id }}"
                        />
                        <x-form.select
                            ...
                            data-id="{{ $inventory->warehouse_erp_id }}"
                        />
                            ...
                            <div class="d-flex gap-1">
                                <div class="m-0">
                                    <input
                                        ...
                                        autocomplete="off"
                                        {{ $inventory->process_cell === 1 ? 'checked' : '' }}
                                    />
                                    <label
                                ...
                                <div class="m-0">
                                    <input
                                        ...
                                        autocomplete="off"
                                        {{ $inventory->process_cell === 2 ? 'checked' : '' }}
                                    />
                                    <label
                                        class="btn btn-outline-primary d-flex align-items-center gap-1"
                                ...
                                <div class="m-0">
                                    <input
                                        ...
                                        autocomplete="off"
                                        {{ $inventory->process_cell === 3 ? 'checked' : '' }}
                                    />
                                    <label
                                        class="btn btn-outline-primary d-flex align-items-center gap-1"
            ...
            >
                ...
                <x-card.nested id="block_1_part">
                    ...
                    <x-slot:body>
                        <x-form.switch
                            ...
                            label="localization.inventory.create.show_leftovers_on_terminal"
                            class="w-full mb-1 d-none"
                            :checked="$inventory->show_leftovers"
                        />
                        ...
                        <x-form.switch
                            ...
                            disabled
                            label="localization.inventory.create.restrict_goods_movement"
                            class="w-full mb-1"
                            :checked="$inventory->restrict_goods_movement"
                        />
                ...
                <x-card.nested id="block_2_part">
                    ...
                    <x-slot:body>
                        ...
                        <x-form.select
                            ...
                            data-parent-id="{{ $inventory->warehouse_id }}"
                            data-related-id="{{ $inventory->zone_id }}"
                            data-edit="true"
                        />
                        <x-form.select
                            id="sector_part"
                            ...
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-parent-id="{{ $inventory->zone_id }}"
                            data-related-id="{{ $inventory->sector_id }}"
                            data-edit="true"
                        />
                        <x-form.select
                            id="row_part"
                            ...
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-parent-id="{{ $inventory->sector_id }}"
                            data-related-id="{{ $inventory->row_id }}"
                            data-edit="true"
                        />
                        <x-form.select
                            id="cell_part"
                            ...
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-parent-id="{{ $inventory->row_id }}"
                            data-related-id="{{ $inventory->cell_id }}"
                            data-edit="true"
                        />
                ...
                <x-card.nested
                    id="block_3_part"
                    style="{{ $inventory->process_cell === 3 ? '' : 'display: none;' }}"
                >
                    <x-slot:header>
                        <x-section-title>
                    ...
                    <x-slot:body>
                        <x-form.select
                            ...
                            data-id="{{ $inventory->category_subcategory }}"
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-edit="true"
                        />
                        ...
                        <x-form.select
                            ...
                            data-id="{{ $inventory->manufacturer_id }}"
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-edit="true"
                        />
                        ...
                        <x-form.select
                            ...
                            data-dictionary="brand"
                            data-dictionary="company"
                            data-id="{{ $inventory->brand }}"
                            :data-custom-options='json_encode([["id" => "all", "text" => __("localization.inventory.create.all")]])'
                            data-edit="true"
                        />
                        ...
                        @php
                            ...
                            $goodsIds = $inventory->goods
                                ->pluck('id')
                                ->map(fn ($id) => (string) $id)
                                ->toArray();
                            $selectIds = $allGoodsSelected ? ['all'] : $goodsIds;
                        @endphp
    ...
    <x-cancel-modal
        ...
        route="/inventory"
        title="{{ __('localization.inventory.cancel.edit.modal.title') }}"
        content="{!! __('localization.inventory.cancel.edit.modal.content') !!}"
